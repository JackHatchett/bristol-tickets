# navigator — teaching_assistant playbook
...
## The rule this playbook exists to obey
...
`tickets.db`, and this playbook may not re-derive any of them from a file on
...
teaching_assistant` is this playbook's input.
