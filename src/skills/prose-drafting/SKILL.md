---
name: prose-drafting
description: Writes and shapes the prose itself: generating options, building a beat sheet, walking a draft with the author, drafting a passage. Use when the work in front of the session is prose being built rather than prose being judged.
license: MIT
metadata:
...
Prose, and the structure under it. Finished prose being read rather than built
is `src/skills/manuscript-review/SKILL.md`; a change to the world or the story
is `src/skills/story-proposals/SKILL.md`.
