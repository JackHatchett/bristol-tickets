...
- **Guardrails cited, never restated:** `src/agent_identities/game_designer.md`
  holds the hard rules; `src/skills/design-proposals/SKILL.md` is the
...
`src/skills/design-proposals/SKILL.md` and any resolved blocker is closed on the board epic.
...
4. **`game_designer` ingests the RETURN per `src/skills/design-proposals/SKILL.md`**: reconciles
...
- `src/skills/design-proposals/SKILL.md` — the procedure that handles a
  RETURN.
