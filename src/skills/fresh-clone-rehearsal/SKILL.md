...
description: Proves a stranger can install this system, by download and by clone, and fixes whatever stops them. Use before anything is pushed to a public remote.
license: MIT
metadata:
...
remote. Input is the committed tree; output is a pass or a list of defects
fixed in the repo. `src/skills/version-control-milestone/SKILL.md` owns
committing.
