---
name: project-intake
description: Sets up a new client or a new project in a standard folder structure any later session can pick up without a briefing. Use when work for a new client, or a new project for an existing one, is starting.
license: MIT
metadata:
...
consistent structure any later session can resume without a briefing.
