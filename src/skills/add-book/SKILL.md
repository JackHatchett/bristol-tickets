---
name: add-book
description: Gets a book into the library as a proper record, by whichever of the three routes suits what is known about it. Use when a book should go into the library.
license: MIT
...
conventions are `src/skills/data-safety/SKILL.md`.
...
new item type. The edition convention table is in `src/skills/data-safety/SKILL.md`.
