...
- **Guardrails cited, never restated:** `jd_evaluation.md` and `cover_letter.md`
...
- **The Gem does not ask the context question.** `jd_evaluation.md`'s ask-once
...
- `src/agent_identities/career_coach.md`, `jd_evaluation.md`,
  `cover_letter.md` — the guardrails cited above.
- `protocols/career_coach/local_fallback.md` — the offline sibling bridge.
